...
def main():
    ...
    operations = ["CREATE TABLE IF NOT EXISTS machines (name VARCHAR(32) NOT NULL, machine VARCHAR(32) PRIMARY KEY, active TINYINT(1) NOT NULL, last_heartbeat TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP, deactivated TINYINT(1) NOT NULL, reason VARCHAR(120))",
